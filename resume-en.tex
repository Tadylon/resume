...
\fileinfo{%
  \faCopyright{} 2024--2026, Tang DeLong \hspace{0.5em}
  \creativecommons{by}{4.0} \hspace{0.5em}
  \githublink{Tadylon}{resume} \hspace{0.5em}
  \faEdit{} \today
}
...
\keywords{C++, Linux, Programming, Python, C, Shell, JavaScript}
...
\profile{
  \mobile{187-8891-2500}
  \email{3151936421@qq.com}
  \github{Tadylon} \\
  \degree{Undergraduate in Bioengineering}
...
%======================================================================
\begin{abstract}
% Highly-motivated undergraduate in Bioengineering
...
% \link{https://github.com/Tadylon}{GitHub}.
...
Hold a degree in Bioengineering and have a solid foundation in programming, mathematics and statistics;
I am passionate about computer and network technologies;
I have two years’ experience using Linux and am proficient in Shell, Python and C++ programming.
I actively practise the principles of free and open-source software;
I have shared several projects on \link{https://github.com/tadylon}{GitHub};
and I actively contribute to numerous other open-source projects.
\end{abstract}
...
%     \icon{\faFreebsd} DragonFly BSD \& FreeBSD (7 years)
  ...
  \comptence{Tools}{%
    SSH, Git, CMake, Docker, VSCode, LaTex
  }
  \comptence{Data Analysis}{%
    Pandas; Matplotlib, Scikit-learn
  }
  \comptence{Web Development}{%
    JavaScript, TypeScript, Vuejs, FastAPI
  }
...
%======================================================================
\begin{itemize}
  \item \link{https://github.com/Tadylon/atoolbox}{\texttt{atoolbox}}:
    (Python, Shell)
    Various tools collected over the years, to help manage systems,
    do daily tasks, analyze data, etc.
  \item \link{https://github.com/Tadylon/dfly-update}{\texttt{dfly-update}}:
    (Shell)
    A simple tool to update a DragonFly BSD system.
  \item \link{https://github.com/Tadylon/openrcs}{\texttt{openrcs}}:
    (C)
    Enhance \texttt{OpenBSD RCS}, to make it compatible with \texttt{GNU RCS}.
  \item \link{https://github.com/Tadylon/fg21sim}{\texttt{fg21sim}}:
    (Python)
    Simulate the low-frequency radio sky maps.
  \item \link{https://github.com/Tadylon/cdae-eor}{\texttt{cdae-eor}}:
    (Python, Keras)
    Use a Convolutional Denoising Autoencoder (CDAE) to separate the
    faint EoR signal.
  \item \link{https://github.com/Tadylon/chandra-acis-analysis}{\texttt{chandra-acis-analysis}}:
    (Python, Shell, Tcl)
    Semi-automate utilities for analyzing X-ray astronomical data.
  \item \link{https://github.com/Tadylon/resume}{\texttt{resume}}:
    (\LaTeX)
...
\begin{itemize}
  \item Developed the low-frequency radio sky image simulation software:
    \link{https://github.com/Tadylon/fg21sim}{\texttt{FG21sim}}.
  \item Developed a suite of utilities to semi-automate the
    X-ray astronomical data analysis:
    \link{https://github.com/Tadylon/chandra-acis-analysis}{\texttt{chandra-acis-analysis}}.
